  ...
  const handleSubmit = (e) => {
    ...
    if (!isValid) {
      ...
      if (calorieSuggestion < 1000) {
        setInvalidDesired(
          "Your desired loss rate is too high for this weight and will result in a calorie suggestion below 1000 calories per day, which is considered unhealthy. Please change your desired loss rate to a lower rate to update your weight."
        );
      } else {
        const newDateInfo = {
