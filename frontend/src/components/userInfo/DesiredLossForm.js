  ...
  const handleSubmit = (e) => {
    ...
    if (!isValid) {
      ...
      const calorieSuggestion = calculateSuggestion(
        ...
        fields.desired_loss_rate
      );
      if (calorieSuggestion < 1000) {
        setInvalidDesired(
          "Your desired loss rate is too high for your weight and activity level and will result in a calorie suggestion below 1000 calories per day, which is considered unhealthy. Please select a lower rate to have a healthier calorie suggestion."
        );
      } else {
        const newDateInfo = {
    ...
    <div>
      <Grid container direction="row">
        ...
        <Grid item container direction="column" xs={10} sm={8} md={4} lg={4}>
            ...
            <Grid container direction="row" alignItems="stretch">
              <Grid item container xs={8} sm={8} md={7} lg={6}>
                ...
                >
                  ...
                  >
                    <MenuItem value={0} className={classes.selectOption}>
                      0.0 lbs/week (maintainance)
                    </MenuItem>
                    <MenuItem value={0.5} className={classes.selectOption}>
                      0.5 lbs/week
                    </MenuItem>
                    <MenuItem value={1} className={classes.selectOption}>
                      1.0 lbs/week
                    </MenuItem>
                    <MenuItem value={1.5} className={classes.selectOption}>
                      1.5 lbs/week
                    </MenuItem>
                    <MenuItem value={2} className={classes.selectOption}>
                      2.0 lbs/week
                    </MenuItem>
                    <MenuItem value={2.5} className={classes.selectOption}>
                      2.5 lbs/week
                    </MenuItem>
                  </Select>
                </FormControl>
              ...
              <Grid item container xs={3} sm={3} md={2} lg={2}>
                ...
                {updatedMessage ? (
                  <FormHelperText className={classes.formUpdated}>
                    {updatedMessage}
                  </FormHelperText>
                ) : null}
              </Grid>
          ...
          {validationErrors.desired_loss_rate ? (
